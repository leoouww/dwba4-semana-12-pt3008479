class Sobre extends React.Component {
  ...
  render() {   
    ...
    <p>Durante sua história, recebeu, também, os nomes de <strong>{this.state.nomes}</strong>. Com a transformação em Instituto, em dezembro de 2008, passou a ter relevância de universidade, destacando-se pela autonomia.</p>
    ...
    <p><strong>{this.state.descritivo}</strong></p>
